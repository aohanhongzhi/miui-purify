...
代码路径： `com/miui/firstaidkit/model/operation` 、`com/miui/firstaidkit/model/other`
...
.end method
# 其中 Lcom/miui/securityscan/model/manualitem/AppUpdateModel 须根据方法所在位置动态调整
# 同时对方法所在类中的 .method public getDesc()Ljava/lang/String; 方法作以下修改：
.method public getDesc()Ljava/lang/String;
    .locals 1
...
```
# 分别搜索代码 key_check_item_update 以及 key_check_item_root，此代码会在两个方法出现，对其中的布尔方法 return false
# 移除相关设置项，代码位置： Lcom/miui/antivirus/activity/SettingsActivity.smali

.method protected onCreate
# 在该方法中分别搜索 preference_key_check_item_update 以及 preference_key_check_item_root 对应的 id（在 res/values/public.xml 可以找到）定位相关项
# 可以发现诸如以下的代码：
...
# preference_key_check_item_root 的修改类似
```
...
代码位置： `com/miui/appmanager/AppManagerMainActivity.smali`

```
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
# 在 res/values/public.xml 中找到 am_setting 对应的 id 并在该方法中搜索，可以发现诸如以下代码：
const v0, 0x7f0a0420
...
iput-object v0, p0, Lcom/miui/appmanager/AppManagerMainActivity;->axN:Landroid/view/MenuItem;

# 在其后增加以下代码(axN 对应上方的 ->axN:Landroid/view/MenuItem;)：
iget-object v0, p0, Lcom/miui/appmanager/AppManagerMainActivity;->axN:Landroid/view/MenuItem;
...
代码路径： `com/miui/applicationlock/utils`
...
代码位置： `com/miui/applicationlock/SettingLockActivity.smali`

```
.method protected onCreate(Landroid/os/Bundle;)V
# 搜索 receive_recommendation 可以发现诸如以下代码：
...
iput-object v0, p0, Lcom/miui/applicationlock/SettingLockActivity;->gP:Landroid/preference/CheckBoxPreference;
...
iget-object v1, p0, Lcom/miui/applicationlock/SettingLockActivity;->gP:Landroid/preference/CheckBoxPreference;

invoke-virtual {v0, v1}, Landroid/preference/PreferenceScreen;->removePreference(Landroid/preference/Preference;)Z
```

代码路径： `com/miui/optimizemanage/settings`

```
# 搜索
key_recommend_news_enable
# 对应的布尔方法，return false

# 搜索 preference_key_recommend_news 定位以下方法：
.method public onCreate(Landroid/os/Bundle;)V
# 在方法结束 return-void 前增加以下代码：
const-string/jumbo v1, "preference_key_information_setting"

invoke-virtual {p0, v1}, Lcom/miui/optimizemanage/settings/c;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
